...
class Device {
	...
	*/
	...
	public static function isSupportBrowser()
	{
	...
	public static function panelNoSupportBrowser()
	{
		if (self::isSupportBrowser()) return false;

		$panel = '
			<div class="panelNoSupportBrowser" style="text-align:center;padding:10px 0;color:rgb(240,240,240);background-color:rgb(90,90,90);">
				В данном браузере сервис будет работать не корректно!
				<br/>
				Рекомендуем зайти с Chrome или с последних версий Opera
			</div>
		';
